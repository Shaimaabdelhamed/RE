...
echo Hello shaimaa
::My code
%MSBUILD_PATH% xUnit\xUnit.csproj
IF !ERRORLEVEL! NEQ 0 goto error
"%DEPLOYMENT_SOURCE%\packages\xunit.runner.console.2.1.0\tools\xunit.console.exe" "%DEPLOYMENT_SOURCE%\xUnit\bin\Debug\xUnit.dll"
IF !ERRORLEVEL! NEQ 0 goto error
